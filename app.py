...
if st.button("メンターに相談する"):
    if not api_key:
        ...
        1. 【受容】温かい言葉で労う、できれば勇気づけをする。    
        2. 【分析】文章から見える「ドライバー(完全であれ、急げ等)、ラケット感情（後悔など）、乗ってしまっている心理ゲーム、７つの習慣からのずれ」が感じられれば、それぞれ指摘(Adult)
        3. 【許可】そのドライバーを緩める言葉、そのラケット感情を捨て去る言葉、心理ゲームから降りるための言葉、７つの習慣に沿わせる言葉を融合する、また、言葉中国の名言名句を提供する
